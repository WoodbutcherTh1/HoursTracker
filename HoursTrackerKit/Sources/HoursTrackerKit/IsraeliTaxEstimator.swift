...
public enum IsraeliTaxEstimator {
    ...
    public struct MonthlyDeductions: Equatable {
        ...
        public let creditOffset: Double
        ...
        public init(
            ...
            self.creditOffset = creditOffset
        }
    }

    public static func estimateMonthlyDeductions(
        monthlyGross: Double,
    ...
    public static func estimateDailyNet(fromDailyGross dailyGross: Double, settings: WorkplaceSettings) -> (
        net: Double,
        incomeTax: Double,
        nationalInsurance: Double,
        healthTax: Double,
