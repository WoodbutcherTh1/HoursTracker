...
public enum DayType: String, Codable, CaseIterable, Identifiable, Sendable {
    case regular
    case restDay
    case holiday
    ...
    // Display names: iOS app `DayType+Localized`.

    public static func automatic(for date: Date, settings: WorkplaceSettings, calendar: Calendar = .current) -> DayType {
...
public struct WorkSession: Codable, Identifiable, Equatable, Sendable {
    ...
    public static func resolveClockPair(
        clockIn: Date,
        clockOut: Date,
    ...
    public static func qualifiesAsNightShift(
        clockIn: Date,
        clockOut: Date,
        calendar: Calendar = .current
    ) -> Bool {
    ...
    public static func calendarDay(for date: Date, calendar: Calendar = .current) -> Date {
