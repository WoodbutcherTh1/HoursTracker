...
public struct WorkplaceSettings: Codable, Equatable {
    ...
    public var workerIDNumber: String
    ...
    public var arrivalRemindersEnabled: Bool
    public var modifiedAt: Date

    public static let `default` = WorkplaceSettings(
        workplaceName: "",
        contractorName: nil,
        workerFullName: "",
        workerIDNumber: "",
    ...
    public func isRestDayWeekday(_ weekday: Int) -> Bool {
    ...
    public mutating func normalizeValidatedFields() {
        ...
        payrollStartDay = min(max(payrollStartDay, 1), 28) // == HistoryPeriodHelper.normalizedStartDay
